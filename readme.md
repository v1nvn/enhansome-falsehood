...
A curated [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 435,723 | 🐛 67 | 📅 2026-01-28 list of falsehoods programmers believe in. A *falsehood* is an ***idea* that you initially believed was true**, but in reality, it is **proven to be false**.
...
* [CLDR currency definitions](https://github.com/unicode-org/cldr/blob/release-40/common/supplemental/supplementalData.xml#L87-L94) ⭐ 1,062 | 🐛 228 | 🌐 Java | 📅 2026-02-07 - Currency validity date ranges overlap due to revolts, invasions, new constitutions, and slow planned adoption.
* [Falsehoods about IBANs](https://github.com/globalcitizen/php-iban/blob/master/docs/FALSEHOODS.md) ⭐ 503 | 🐛 8 | 🌐 PHP | 📅 2025-12-03 - International Bank Account Numbers are not international.
* [`tax`](https://github.com/commerceguys/tax) ⭐ 285 | 🐛 12 | 🌐 PHP | 📅 2025-07-08 - A PHP 5.4+ tax management library.
...
* [Falsehoods about Bitcoin](https://github.com/theborakompanioni/spring-boot-bitcoin-starter/blob/master/docs/FALSEHOODS.md) ⭐ 80 | 🐛 16 | 🌐 Java | 📅 2026-02-03 - A list of mistaken perspectives on Bitcoin.
...
* [`libvldmail`](https://github.com/dertuxmalwieder/libvldmail) ⭐ 64 | 🐛 0 | 🌐 C | 📅 2025-11-10 - A library that implements RFC-based checks for e-mail addresses.
...
* [Big List of Naughty Strings](https://github.com/minimaxir/big-list-of-naughty-strings) ⭐ 47,584 | 🐛 108 | 🌐 Python | 📅 2024-04-18 - A huge corpus of strings which have a high probability of causing issues when used as user-input data. A must have set of practical edge-cases to test your software against.
* [Awesome Unicode](https://github.com/Wisdom/Awesome-Unicode) ⭐ 966 | 🐛 8 | 🌐 JavaScript | 📅 2022-07-01 - A curated list of delightful Unicode tidbits, packages and resources.
* [i18n Testing Data](https://github.com/patch/i18n-testing) ⭐ 65 | 🐛 3 | 📅 2020-04-28 - Compilation of real-word international and diverse name data for unit testing and QA.
...
* [`hostname-validate`](https://github.com/jakeogh/hostname-validate) ⭐ 5 | 🐛 0 | 🌐 Python | 📅 2022-11-04 - An attempt to validate hostnames in Python.

## Phone Numbers

* [Falsehoods about Phone Numbers](https://github.com/googlei18n/libphonenumber/blob/master/FALSEHOODS.md) ⭐ 17,817 | 🐛 122 | 🌐 C++ | 📅 2026-02-01 - Covers phone numbers, their representation and meaning.
* [`libphonenumber`](https://github.com/googlei18n/libphonenumber) ⭐ 17,817 | 🐛 122 | 🌐 C++ | 📅 2026-02-01 - Google's common Java, C++ and JavaScript library for parsing, formatting, and validating international phone numbers. Also available for [C#](https://github.com/twcclegg/libphonenumber-csharp) ⭐ 890 | 🐛 8 | 🌐 C# | 📅 2026-01-30, [Objective-C](https://github.com/iziz/libPhoneNumber-iOS) ⭐ 2,372 | 🐛 0 | 🌐 Objective-C | 📅 2025-12-05, [Python](https://github.com/daviddrysdale/python-phonenumbers) ⭐ 3,707 | 🐛 12 | 🌐 Python | 📅 2026-01-30, [Ruby](https://github.com/sstephenson/global_phone) ⚠️ Archived and [PHP](https://github.com/giggsey/libphonenumber-for-php) ⭐ 4,994 | 🐛 3 | 🌐 PHP | 📅 2026-01-30.

## Postal Addresses

* [`addressing`](https://github.com/commerceguys/addressing) ⭐ 947 | 🐛 22 | 🌐 PHP | 📅 2026-01-05 - A PHP 5.4+ addressing library, powered by Google's dataset.
* [`libaddressinput`](https://github.com/googlei18n/libaddressinput) ⭐ 614 | 🐛 47 | 🌐 C++ | 📅 2025-06-12 - Google's common C++ and Java library for parsing, formatting, and validating international postal addresses.
...
* [`address`](https://github.com/Boostport/address) ⭐ 96 | 🐛 0 | 🌐 Go | 📅 2025-08-15 - Go library to validate and format addresses using Google's dataset.
...
* [Falsehoods about Quantum Technology](https://github.com/gottfriedsz/falsehoods-quantum) ⭐ 11 | 🐛 0 | 📅 2023-10-09 - Common misconceptions about quantum technology and computers.
...
* [Falsehoods about Cars](https://github.com/driveto/falsehoods-about-cars) ⚠️ Archived - Even something as common as defining a car is full of pitfalls.
...
* [Falsehoods about Fonts](https://github.com/RoelN/Font-Falsehoods) ⭐ 112 | 🐛 5 | 📅 2018-01-23 - Assumptions about typography on the web and in desktop applications.
...
Your contributions are always welcome! Please take a look at the [contribution guidelines](https://github.com/kdeldycke/awesome-falsehood/blob/main/.github/contributing.md) ⭐ 27,009 | 🐛 7 | 📅 2026-01-20 first.

## Footnotes

This list gathered some popularity in social medias over the past few years. See it being [discussed and mentioned elsewhere](https://github.com/kdeldycke/kdeldycke/blob/main/in-the-media.md) ⭐ 6 | 🐛 6 | 📅 2025-10-11.

The [header image](https://github.com/kdeldycke/awesome-falsehood/blob/main/assets/awesome-falsehood-header.jpg) ⭐ 27,009 | 🐛 7 | 📅 2026-01-20 is based on a modified [photo taken in February 2010 by Iza Bella](https://commons.wikimedia.org/wiki/File:BLW_Truth_and_Falsehood.jpg), distributed under a [Creative Commons BY-SA 2.0 UK license](https://creativecommons.org/licenses/by-sa/2.0/uk/deed.en).
